...
export class ProductsService {
  ...
  findAll(): Promise<Product[]> {
    return this.productsRepository.find({
      relations: ['productSaleslocation', 'productCategory'], // productSaleslocation 칼럼을 join해서 가져온다.
    });
  }
  ...
  findOne({ productId }: IProductsServiceFindOne): Promise<Product> {
    return this.productsRepository.findOne({
      where: { id: productId },
      relations: ['productSaleslocaton', 'productCategory'], // productSaleslocation 칼럼을 join해서 가져온다.
    });
  }
