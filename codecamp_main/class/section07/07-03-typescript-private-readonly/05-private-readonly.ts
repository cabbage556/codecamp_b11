...
// private readonly => NestJS ⭐️⭐️⭐️⭐️⭐️
...
class Monster2 {
  ...
  constructor(private readonly power) {
    // 클래스 내부에서만 접근 가능, 수정은 불가능 / 자식 클래스 내부에서 접근, 수정 불가능
...
class 공중몬스터2 extends Monster2 {
  attack2 = () => {
    console.log("공격하자~");
    // console.log("내 공격력은 " + this.power + "!!"); // 자식 클래스 내부에서 접근 불가능
    // this.power = 30; // 자식 클래스 내부에서 수정 불가능
  };
}
